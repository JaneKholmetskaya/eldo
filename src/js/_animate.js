function initAnimmation() {
  ...
  const left = () => "left";
  if ($(".icons-wrapper .circle_animation").length > 0) {
    $(".icons-wrapper .circle_animation").map((i, el) => {
      ...
      if (el.animate) {
        ...
        $(".icons-wrapper .circle_animation").addClass("transfrorm");
      }
    });
  }
  ...
  //   );
  // });
  if ($(".icons-wrapper .circle_animation:nth-child(2n+1)").length > 0) {
  ...
  if ($(".icons-wrapper .circle").length > 0) {
